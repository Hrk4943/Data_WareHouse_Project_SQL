/*
	...
	-----------Bronze Layer Cleaned Data Loaded to Silver Layer-----------------
	----------------------------------------------------------------------------
===============================================================================
...
*/
	...
	CREATE OR ALTER PROCEDURE silver.load_silver AS /* creating a stored procedure for silver layer*/
	BEGIN
	...
	INSERT INTO silver.crm_cust_info(
		...
		CASE 
			...
			ELSE 'n/a' /* for replacing the NULL values*/
...
EXEC silver.load_silver; /* executing the stored procedure created for silver layer */  
